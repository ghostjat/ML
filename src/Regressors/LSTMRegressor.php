 ...
 * LSTM Regressor
 *
 * A Long Short-Term Memory network for time-series regression. The LSTM layer
 * addresses the vanishing-gradient problem of vanilla RNNs through a gated
 * cell-state mechanism, making it better suited for long-range dependencies.
 *
 ...
 *   Placeholder1D → LSTM → [extra Dense layers] → Dense(1) → Continuous
 *
 * @category    Machine Learning
 * @package     Rubix/ML
 * @author      The Rubix ML Community
 */
class LSTMRegressor implements Estimator, Learner, Online, Verbose, Persistable
{
     ...
     * @param Hidden[]         $extraHidden     Additional Dense layers after LSTM
     * @param int              $batchSize
    ...
    /**
     * Train the LSTM on a labeled dataset.
     *
    ...
    {
        return 'LSTM Regressor (' . Params::stringify($this->params()) . ')';
    }
}
